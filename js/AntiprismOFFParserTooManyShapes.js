...
Object.assign(Object.setPrototypeOf(OFFParser.prototype, X3D.X3DParser.prototype),
   {
      ...
      shape() {
         ...
         // const edgeTransform = this.edgesShapeTriangleSet(vertices, offData.edges, offData.edgesColor);
         // const edgeTransform = this.edgesShapeInstance(vertices, offData.edges, offData.edgesColor);
         ...
         // const vertexTransform = this.verticesShapeTriangleSet(vertices, offData.verticesColor);
      ...
      verticesShapePointSet(vertices, verticesColor) {
         const scene = this.getExecutionContext();
         const groupTransform = scene.createNode("Transform");
      ...
      verticesShapeInstance(vertices, verticesColor) {
         const scene = this.getExecutionContext();
         const groupTransform = scene.createNode("Transform");
      ...
      verticesShapeTriangleSet(vertices, verticesColor) {
         const scene = this.getExecutionContext();
         const groupTransform = scene.createNode("Transform");
      ...
      edgesShapeInstance(vertices, edges, edgesColor) {
         const scene = this.getExecutionContext();
         const groupTransform = scene.createNode("Transform");
         const shape = scene.createNode("InstancedShape");
      ...
      edgesShapeTriangleSet(vertices, edges, edgesColor) {
         const scene = this.getExecutionContext();
         const groupTransform = scene.createNode("Transform");
